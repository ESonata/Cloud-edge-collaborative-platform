          ...
          <script type="text/javascript">
          				...
          				var INTime=$("#INTime").val();
          			  	...
          			  	$.post(
          					...
          					{"ID":ID,"bookName":bookName,"typeBID":typeBID,"typeID":typeID,"price":price,"nowPrice":nowPrice,"introduce":introduce,
          					 "author":author,"publish":publish,"newBook":newBook,"sale":sale,"picture":picture,"INTime":INTime},
          					function(data)
          					{
          						 alert(data);
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <!--新增图书名称-->
                            <input type="text" id="bookName" name="bookName" class="form-control" value="${showBookInfo.bookName }" required autofocus autocomplete="off">
                        </div>
                        <!--<div class="form-group">-->
                        ...
                        <%--<div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">--%>
                            ...
                            <%--<div class="add-article-box-content">--%>
                                ...
                                <%--<select id="typeID" class="form-control" name="typeID">--%>
                                	<%--<option value="${showBookInfo.typeID }" selected>${showBookInfoSubType }</option>--%>
                                 <%----%>
                                <%--</select>--%>
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <select id="newBook" class="form-control" name="newBook">
                                		<option value="${showBookInfo.newBook }" selected>
                                			<c:if test="${showBookInfo.newBook==1 }" >是</c:if>
                							<c:if test="${showBookInfo.newBook==0 }" >否</c:if>
                                		
                                		</option>
                                	<c:if test="${showBookInfo.newBook!=1 }" >
                                		 <option value="1" >是</option>
                                	</c:if>
                                    <c:if test="${showBookInfo.newBook!=0 }" >
