        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
           ...
           <br>
            ...
            <div style="margin-left:850px;height:60x;width:400px">
         					<c:if test="${curPage!=1}">
          							<a href="/Semester_Demo/ManageUserListServlet?curPage=${curPage-1}" style="font-size:16px" onmouseover="javascript:this.style.color='deepskyblue';this.style.cursor='pointer'" onmouseout="javascript:this.style.color='black'">上一页</a>
          					
          					</c:if>
							<c:if test="${curPage<totalPage }">
									<a href="/Semester_Demo/ManageUserListServlet?curPage=${curPage+1}" style="font-size:16px" onmouseover="javascript:this.style.color='deepskyblue';this.style.cursor='pointer'" onmouseout="javascript:this.style.color='black'">下一页</a>
          					</c:if>
                ...
                if (window.confirm("此操作不可逆，是否确认？")) {
                    $.ajax({
                        ...
                        success: function (data) {
                        		...
                        		{
                        			alert(data);
                        			window.location.href="/Semester_Demo/UserListServlet?curPage=1";
                        		}
