...
<div class="container">
  <div class="siteIcon"><img src="images/icon/damaiz_icon.png" alt="" data-toggle="tooltip" data-placement="top" title="欢迎使用大麦网管理系统" draggable="false" /></div>
    <form action="/admin/login" >
      <div  autocomplete="off" class="form-signin">
         <h2 class="form-signin-heading">管理员登录</h2>
            ...
            <input type="password" id="userPwd" name="password" class="form-control" placeholder="请输入密码" required autofocus autocomplete="off" maxlength="18">
  ...
  <div></div>
    ...
    <p><a href="/login.do" data-toggle="tooltip" data-placement="left" title="不知道自己在哪?">回到前台 →</a></p>
  </div>
</div>
