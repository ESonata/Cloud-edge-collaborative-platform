        ...
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <c:if test="${manageuser.order==1}">
                    <li class="active"><a href="/Semester_Demo/FindAllordersServlet?curPage=1">订单</a></li>
                </c:if>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="/Article/checkAll" method="post" >
                ...
                <div class="book-search" style="margin-top: -50px" >
                    ...
                    <input type="text" placeholder="根据收货人查询订单" name="OrderSearchByKeyword" id="OrderSearchByKeyword">
                    <button class="book-search-1" onclick="searchorder(1)">
