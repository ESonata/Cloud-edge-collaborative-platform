...
<div class="container-fluid">
	<div class="col-md-4">
		<a href="/frontindex">
			<img src="img/logo2.png" style="height:60px"/>
		</a>
	</div>
	<div class="col-md-5">　
		<img src="" />
	...
	<div class="col-md-3" style="padding-top:20px;margin-left:860px;margin-top:-50px;margin-bottom:15px;width:600px">
		<ol class="list-inline">
			...
			<li><a href="${pageContext.request.contextPath }/FVoteListIndexServlet?curPage=1">畅享投票</a></li>
			<li><a href="${pageContext.request.contextPath }/MyMarkServlet?curPage=1">我的评论</a></li>
			<li><a href="${pageContext.request.contextPath }/MyLoveListServlet?curPage=1">我的收藏</a></li>
		</ol>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<form class="navbar-form navbar-right" role="search"  action="${pageContext.request.contextPath }/SerachBookResultServlet" method="post">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="SearchBook" onkeyup="searchWord(this)" name="searchinput" id="searchinput" onblur="closeshowdiv(this)">
...
<script type="text/javascript">
	...
	function searchWord(obj)
	{
		...
		var content="";
		$.post(
			"${pageContext.request.contextPath}/SearchBookInfoServlet",
			{"word":word},
			function(data){
				/* 3.将返回的数据显示在框中 */
