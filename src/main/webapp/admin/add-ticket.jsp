    ...
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
          <c:if test="${manageuser.book==1}">
      	 <li><a href="/AdminGetInitBookInfoServlet?curPage=1">图书</a></li>
      </c:if>
          			...
          			function fn1()
          			{
          				...
          				var INTime=$("#INTime").val();
          			  	...
          			  	$.post(
          					...
          					{"bookName":bookName,"typeBID":typeBID,"typeID":typeID,"price":price,"nowPrice":nowPrice,"introduce":introduce,
