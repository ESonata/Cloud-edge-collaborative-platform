            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="add-article-box" style="width:49%;display: inline-block;">
                        ...
                        <div class="add-article-box-content">
                            <!--新增图书定价-->
                            <input type="text" class="form-control"  value="${TicketInfo.price }" name="price" autocomplete="off" id="price">
                    ...
                    <div class="add-article-box" style="width:50%;display: inline-block;right: 1%;">
                        ...
                        <div class="add-article-box-content">
                            <!--新增图书现价-->
                            <input type="text" class="form-control" value="${TicketInfo.nowPrice }"  name="nowPrice" autocomplete="off" id="nowPrice">
                    ...
                    <div class="add-article-box" style="width: 48%;display: inline-block">
                        ...
                        <button type="submit" class="btn btn-default" style="display: inline">
                            <li><a  data-toggle="modal" data-target="#addPrice">增加票价档次</a></li>
                        </button>
                        <button type="submit" class="btn btn-default" style="display: inline">
                        ...
                        <div class="add-article-box-content">
                            ...
                            <p>
                                ...
                                <span class="article-time-display">
                                             <input style="border: none;"  name="INTime" type="datetime-local" value="${TicketInfo.INTime}" id="INTime"/>
                                        </span>
                            </p>
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <!--新增作者姓名-->
                            <input type="text" class="form-control" value="${TicketInfo.author }" name="author" autocomplete="off" id="author">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <!--新增是否新品-->
                            <input class="form-control" value="${TicketInfo.newTicket}">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <input class="form-control" value="${TicketInfo.sale}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top: 10px">
                    ...
                    <table class="table" style="margin-bottom:0px;">
                        ...
                        <tr>
                            <td wdith="20%">票务价格:</td>
                            <td width="80%"><input type="text" value="" id="ticketPrice"  class="form-control" name="ticketPrice" maxlength="10" autocomplete="off" /></td>
                        </tr>
                        </tbody>
                        <tfoot>
                        <tr></tr>
                ...
                <table class="table" style="margin-bottom:0px;">
                   ...
                   <c:forEach items="${priceList}" var="p">
                       <tr>
                           <td wdith="20%">价格档次:</td>
                           <td width="60%">
                               <input type="text" value="${p.price}" readonly  class="form-control" name="votename" maxlength="10" autocomplete="off" />


                           </td>
                           <td>
                               <button class="btn btn-default" tid="${p.tid}" price="${p.price}" onclick="deletePrice(this)" style="display: inline;"> 删除</button>
                             </td>
